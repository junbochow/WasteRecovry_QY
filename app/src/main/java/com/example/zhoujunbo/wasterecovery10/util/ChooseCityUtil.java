...
import com.example.zhoujunbo.wasterecovery10.mode.CityBean;
import com.example.zhoujunbo.wasterecovery10.mode.CityData;
...
//        bean = JSON.parseObject(CityData.getJson(), CityBean.class);//使用fastjson,用户可自行选择添加依赖和jar包
        Gson gson = new Gson();
